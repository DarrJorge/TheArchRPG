...
UBTTask_RotateToFaceTarget::UBTTask_RotateToFaceTarget()
{
	...
	TargetToFaceKey.AddObjectFilter(this, GET_MEMBER_NAME_CHECKED(ThisClass, TargetToFaceKey),
		AActor::StaticClass());
}
...
FString UBTTask_RotateToFaceTarget::GetStaticDescription() const
{
	...
	return FString::Printf(TEXT("Smoothly rotates to face %s Key until the angle precison %s is reached"),
...
EBTNodeResult::Type UBTTask_RotateToFaceTarget::ExecuteTask(UBehaviorTreeComponent& OwnerComp, uint8* NodeMemory)
{
	...
	const auto TargetObject = Blackboard->GetValueAsObject(TargetToFaceKey.SelectedKeyName);
