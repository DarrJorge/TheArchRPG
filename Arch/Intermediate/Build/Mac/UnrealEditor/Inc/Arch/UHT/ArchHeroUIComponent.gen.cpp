...
void FOnAbilityCooldownBegin_DelegateWrapper(const FMulticastScriptDelegate& OnAbilityCooldownBegin, FGameplayTag AbilityInputTag, float TotalCooldownTime, float RemainingCooldownTime)
{
	...
	struct Z_Construct_UDelegateFunction_Arch_OnPickUpItemInteracted__DelegateSignature_Statics
	{
		struct _Script_Arch_eventOnPickUpItemInteracted_Parms
		{
			bool bShouldDisplayInputKeyWidget;
			FText InputKeyText;
		};
		static void NewProp_bShouldDisplayInputKeyWidget_SetBit(void* Obj);
		static const UECodeGen_Private::FBoolPropertyParams NewProp_bShouldDisplayInputKeyWidget;
		static const UECodeGen_Private::FTextPropertyParams NewProp_InputKeyText;
		static const UECodeGen_Private::FPropertyParamsBase* const PropPointers[];
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam Function_MetaDataParams[];
#endif
	...
	void Z_Construct_UDelegateFunction_Arch_OnPickUpItemInteracted__DelegateSignature_Statics::NewProp_bShouldDisplayInputKeyWidget_SetBit(void* Obj)
	{
		((_Script_Arch_eventOnPickUpItemInteracted_Parms*)Obj)->bShouldDisplayInputKeyWidget = 1;
	}
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UDelegateFunction_Arch_OnPickUpItemInteracted__DelegateSignature_Statics::NewProp_bShouldDisplayInputKeyWidget = { "bShouldDisplayInputKeyWidget", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(_Script_Arch_eventOnPickUpItemInteracted_Parms), &Z_Construct_UDelegateFunction_Arch_OnPickUpItemInteracted__DelegateSignature_Statics::NewProp_bShouldDisplayInputKeyWidget_SetBit, METADATA_PARAMS(0, nullptr) };
	const UECodeGen_Private::FTextPropertyParams Z_Construct_UDelegateFunction_Arch_OnPickUpItemInteracted__DelegateSignature_Statics::NewProp_InputKeyText = { "InputKeyText", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Text, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(_Script_Arch_eventOnPickUpItemInteracted_Parms, InputKeyText), METADATA_PARAMS(0, nullptr) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UDelegateFunction_Arch_OnPickUpItemInteracted__DelegateSignature_Statics::PropPointers[] = {
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UDelegateFunction_Arch_OnPickUpItemInteracted__DelegateSignature_Statics::NewProp_bShouldDisplayInputKeyWidget,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UDelegateFunction_Arch_OnPickUpItemInteracted__DelegateSignature_Statics::NewProp_InputKeyText,
	};
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UDelegateFunction_Arch_OnPickUpItemInteracted__DelegateSignature_Statics::Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "Public/Components/UI/ArchHeroUIComponent.h" },
	};
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UDelegateFunction_Arch_OnPickUpItemInteracted__DelegateSignature_Statics::FuncParams = { (UObject*(*)())Z_Construct_UPackage__Script_Arch, nullptr, "OnPickUpItemInteracted__DelegateSignature", nullptr, nullptr, Z_Construct_UDelegateFunction_Arch_OnPickUpItemInteracted__DelegateSignature_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_Arch_OnPickUpItemInteracted__DelegateSignature_Statics::PropPointers), sizeof(Z_Construct_UDelegateFunction_Arch_OnPickUpItemInteracted__DelegateSignature_Statics::_Script_Arch_eventOnPickUpItemInteracted_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00130000, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_Arch_OnPickUpItemInteracted__DelegateSignature_Statics::Function_MetaDataParams), Z_Construct_UDelegateFunction_Arch_OnPickUpItemInteracted__DelegateSignature_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_Arch_OnPickUpItemInteracted__DelegateSignature_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UDelegateFunction_Arch_OnPickUpItemInteracted__DelegateSignature_Statics::_Script_Arch_eventOnPickUpItemInteracted_Parms) < MAX_uint16);
	UFunction* Z_Construct_UDelegateFunction_Arch_OnPickUpItemInteracted__DelegateSignature()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UDelegateFunction_Arch_OnPickUpItemInteracted__DelegateSignature_Statics::FuncParams);
		}
		return ReturnFunction;
	}
void FOnPickUpItemInteracted_DelegateWrapper(const FMulticastScriptDelegate& OnPickUpItemInteracted, bool bShouldDisplayInputKeyWidget, const FText& InputKeyText)
{
	struct _Script_Arch_eventOnPickUpItemInteracted_Parms
	{
		bool bShouldDisplayInputKeyWidget;
	...
	_Script_Arch_eventOnPickUpItemInteracted_Parms Parms;
	Parms.bShouldDisplayInputKeyWidget=bShouldDisplayInputKeyWidget ? true : false;
	Parms.InputKeyText=InputKeyText;
	OnPickUpItemInteracted.ProcessMulticastDelegate<UObject>(&Parms);
}
...
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_OnPickUpItemInteracted_MetaData[];
#endif
		static const UECodeGen_Private::FMulticastDelegatePropertyParams NewProp_OnPickUpItemInteracted;
		static const UECodeGen_Private::FPropertyParamsBase* const PropPointers[];
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UArchHeroUIComponent_Statics::NewProp_OnPickUpItemInteracted_MetaData[] = {
		{ "ModuleRelativePath", "Public/Components/UI/ArchHeroUIComponent.h" },
	};
#endif
	const UECodeGen_Private::FMulticastDelegatePropertyParams Z_Construct_UClass_UArchHeroUIComponent_Statics::NewProp_OnPickUpItemInteracted = { "OnPickUpItemInteracted", nullptr, (EPropertyFlags)0x0010100010080000, UECodeGen_Private::EPropertyGenFlags::InlineMulticastDelegate, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UArchHeroUIComponent, OnPickUpItemInteracted), Z_Construct_UDelegateFunction_Arch_OnPickUpItemInteracted__DelegateSignature, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UArchHeroUIComponent_Statics::NewProp_OnPickUpItemInteracted_MetaData), Z_Construct_UClass_UArchHeroUIComponent_Statics::NewProp_OnPickUpItemInteracted_MetaData) }; // 3573433889
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UArchHeroUIComponent_Statics::PropPointers[] = {
		...
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UArchHeroUIComponent_Statics::NewProp_OnPickUpItemInteracted,
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_darr_jorge_Projects_Unreal_TheArchRPG_Arch_Source_Arch_Public_Components_UI_ArchHeroUIComponent_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UArchHeroUIComponent, UArchHeroUIComponent::StaticClass, TEXT("UArchHeroUIComponent"), &Z_Registration_Info_UClass_UArchHeroUIComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UArchHeroUIComponent), 979403803U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_darr_jorge_Projects_Unreal_TheArchRPG_Arch_Source_Arch_Public_Components_UI_ArchHeroUIComponent_h_358863409(TEXT("/Script/Arch"),
